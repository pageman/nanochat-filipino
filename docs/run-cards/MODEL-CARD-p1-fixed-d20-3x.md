...
**Eval:** `val_bpb_full=1.172248`; one `test_bpb=1.164768` after validation-only selection. One seed. Margin to depth 8 is 0.0069 BPB and is not interpreted as a ranking.
...
**Citations:** Cruz & Cheng (2019), arXiv:1907.00409; Karpathy nanochat; AsPredicted #306780.
