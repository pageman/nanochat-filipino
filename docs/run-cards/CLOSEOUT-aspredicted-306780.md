# Super-Exhaustive Close-Out Checklist for AsPredicted #306780
...
1. The named file `manifests/selection_record.json` was materialized at 2026-08-16T09:13:00Z, after the one test read. The sealed selection already existed in `val_baselines_summary.json` at 2026-08-16T07:56:24Z with `test_read_count=0` (SHA-256 `9d461cc5ad606d129e1de0be12ad372e63f5ee8bc4886b2969506625b057467f`). The named file reconstructs that sealed decision and does not reopen `D*`.
...
6. Pod `68bei7d3vx4krc` was stopped after archive (`status=EXITED`). GPU billing stopped; disk persists until terminate. Weights and train logs are on the Mac.
...
| Model code | nanochat pinned to `92d63d4` plus documented data-directory integration. | Held. Full SHA `92d63d4e8bb4df75c3b71618f31ddde2378b2bcd`; hook `faaded83ef79e6d5b2e6856a444cf17e20ddb534ddd29d6b600f9568304ec4ff` |
...
| Registration PDF SHA-256 | `a34f119df557d2e763aa154e02b76b0ebcbcba1f3fb32c3219d85ae6395cc5ca` | PP / verified |
| Execution clarification path/SHA-256 | `docs/EXECUTION-CLARIFICATIONS-p1.1.md` / `71c2b992ef1771fc7f31cad6d2f259d23d5c3b99367e7b9cbdcf7ae749552c8e` | PP / verified |
| Ledger path/SHA-256 | `manifests/gate_ledger.json` / `5626863de89158960d2b7ba9d2f1fdb314110ab45264fa3d464c6c4b1f427b0e` | PP / after named-event backfill |
...
| Report author/reviewer | Paul Pajo / `docs/run-cards/RESULTS-p1.1-aspredicted-306780.md` SHA `cd9e0c78fa45e2c8e66f9999d055ce171ef64b3ab31910e3de1cb2466ea27fda` | PP |
| Host/Pod status | Official I/J host Runpod Secure A40 `68bei7d3vx4krc` / `p1-gate-i` / EU-SE-1. **Stopped (`EXITED`) after Mac archive.** GPU billing off; volume persists until terminate. | PP / 2026-08-16T09:16:00Z |
...
|---:|---|---|---|---|---|---|---|---|---|
| 8 | `p1-fixed-d8-3x` | `artifacts/p1/p1-20260816T025911Z-0067a57/checkpoints/p1-fixed-d8-3x/model_000294.pt` | [x] | [x] | `9c407f4fbc6f5bb2b40a36ae49fb38d088fa025b4f317e1ddaa629cc2068bbea` | `ef85aaa88cf77914308133e388851874d2c21f50dca8f6b4053431a972481d18` | `5ab91417ea0a85ecec0b529f564ec69ca24e8337a1d6bda63cd102ef6e676afa` | 0 | PP |
| 12 | `p1-fixed-d12-3x` | `artifacts/p1/p1-20260816T025911Z-0067a57/checkpoints/p1-fixed-d12-3x/model_000294.pt` | [x] | [x] | `5dfccc27b8b27c7c03faaeb92c1cbf1c884659b03795baa18921386d15e5277e` | `383a3107f63cba48b21ab684798524eca2b8e2c44c6a1894695277938e7e38ad` | `5bb7a59a1579d1b077b656f13af8ce8815bddcb79c63fd055f84d88566173592` | 0 | PP |
| 16 | `p1-fixed-d16-3x` | `artifacts/p1/p1-20260816T025911Z-0067a57/checkpoints/p1-fixed-d16-3x/model_000294.pt` | [x] | [x] | `525301ebe3bc80875b31dd3f7fa19e12fc5405565f7b973811c0647168445cbf` | `f3e23ee218839f4ce2b6cc9a018da6e39fa4606edb2bde1eff57ba5690ea3421` | `898039e66e22ec9b1cfcf26d5ae609a7b9b33dedf2cf0e18257f3a33ab514c9d` | 0 | PP |
| 20 | `p1-fixed-d20-3x` | `artifacts/p1/p1-20260816T025911Z-0067a57/checkpoints/p1-fixed-d20-3x/model_000294.pt` | [x] | [x] | `9e30fff3d6effc7c71af92e8488f9375a5d70cf1962ba371bee0e639836dde38` | `62c3ea5e50082d3bc4ccacbe34ed429e67b3f2170c352354472622cfae59ec7b` | `81700800255656a5bf71265a9da8254052f6ed486ff5241bbed1380c2095cd88` | 0 | PP |

`{p1-20260816T025911Z-0067a57}` = `p1-20260816T025911Z-0067a57`. Train UTC: d8 07:04:33–07:08:19; d12 07:08:20–07:14:21; d16 07:14:21–07:24:50; d20 07:24:50–07:41:32.
...
- [x] Store checkpoint hashes in `manifests/final_checkpoint_manifest.json` (SHA `e25663f9fbade93889a8f05f75e710f5c275e9ce26d080800adee921d431751c`).
- [x] Store run-card hashes in the same manifest. d8 `1b9834dd856e400ce465e356c6a1f15f06c68bb6e2b8b461021edfc021d5cdc2`; d12 `2c4996e551fa8944b3800503cca79b468e2b32292f6747f495ca183621ad1094`; d16 `f80ac80e9efec0447c042412c0cb1e471f8d1722ecd967891b53853177589660`; d20 `cba57395737c2c2d8e3210b7542336197ba121f2a2311aa4640bcdcf5364acd4`.
...
- [x] Stop or disable training/auto-restart jobs before evaluation began. Training ended 07:41:32Z; Gate J started 07:50:27Z. Idle pod later **stopped (`EXITED`)** after Mac archive.
...
- [x] Raw WikiText-TL-39 Parquet SHA-256 equals `source_manifest.json`. `706d7064…` / manifest SHA `5be73a4bf8f546dea150635429d35c95812077cadea872dc5e4fbbed1cf6ba92`.
- [x] Split manifest SHA-256 equals frozen split record. `b8c180a21addd9ac2bbb5b1bdb6ef7ae3246f5c58df925f7cb8a3abbb8b56326`.
- [x] Train shard manifest SHA-256 equals frozen shard record. `de86c9de2e4c9cc956506e8e86aef087233747ddb366951899c0a02afb9f8f9f`; shards `aaf81d95…` / `c57c11a2…`.
...
- [x] Tokenizer model/files hash equals tokenizer manifest. `04436b854e0841025a3dd2b46baaeeea07a7ccc252e9f99a19171306f00bc5a8`. Manifest SHA `5cd96dbe9936276e9ae60af490b54298d71ebbdb856cd0ef728cf2bca2637c1b`.
- [x] Evaluator code commit equals pinned nanochat commit plus documented patch identity. `92d63d4e…` + hook `faaded83ef79e6d5b2e6856a444cf17e20ddb534ddd29d6b600f9568304ec4ff`. Evaluator script `405d97a83fbdceaed4f7845cc5c53f65688866aa18eb001cf20961c89a814016`.
...
- [x] GPU model/VRAM, CUDA driver, PyTorch, CUDA runtime, Python, and container/image tag are captured. A40 48 GB; image `runpod/pytorch:1.0.3-cu1281-torch291-ubuntu2404`; torch `2.9.1+cu128`; preflight SHA `5cbe846f6181e6d105a19d8ac2ba49c4ed5d9f2fd0f832db457816060f8fe4c4`.
...
|---|---|---|---|---|---|---|---|---|
| `P1-FVAL-d8` | d8 | `9c407f4fbc6f5bb2b40a36ae49fb38d088fa025b4f317e1ddaa629cc2068bbea` | 2026-08-16T07:50:27Z | 2026-08-16T07:51:08Z | 0 | [x] | [x] | `74765238b1ab0358ae02000ccb5b1b8738a27a96e7f07eee10797dd58ec5423f` |
| `P1-FVAL-d12` | d12 | `5dfccc27b8b27c7c03faaeb92c1cbf1c884659b03795baa18921386d15e5277e` | 2026-08-16T07:51:08Z | 2026-08-16T07:52:10Z | 0 | [x] | [x] | `ecb4e8bbe8e37cdaa35acad468c8dd95d28e4bd266df6e55e777f11924f7cebd` |
| `P1-FVAL-d16` | d16 | `525301ebe3bc80875b31dd3f7fa19e12fc5405565f7b973811c0647168445cbf` | 2026-08-16T07:52:10Z | 2026-08-16T07:53:47Z | 0 | [x] | [x] | `86091351a47a2fdbd35e89e2cdbdb49bc7283645bce39a17614770523d77e7ab` |
| `P1-FVAL-d20` | d20 | `9e30fff3d6effc7c71af92e8488f9375a5d70cf1962ba371bee0e639836dde38` | 2026-08-16T07:53:47Z | 2026-08-16T07:56:24Z | 0 | [x] | [x] | `906f6dc465303ea39f37d1689ab05915c986f77a90b90d68e8e3f831e1219195` |
...
|---:|---|---:|---:|---:|---:|---:|---:|---:|---|---|
| 8 | `9c407f4fbc6f5bb2b40a36ae49fb38d088fa025b4f317e1ddaa629cc2068bbea` | 0.836702 | 1.179135 | 0.342432 | 4796649.5 | 1286864 | 5868797 | 7472 | `405d97a83fbdceaed4f7845cc5c53f65688866aa18eb001cf20961c89a814016` | [x] |
| 12 | `5dfccc27b8b27c7c03faaeb92c1cbf1c884659b03795baa18921386d15e5277e` | 0.528818 | 1.180824 | 0.652006 | 4803521.0 | 1286864 | 5868797 | 7472 | `405d97a83fbdceaed4f7845cc5c53f65688866aa18eb001cf20961c89a814016` | [x] |
| 16 | `525301ebe3bc80875b31dd3f7fa19e12fc5405565f7b973811c0647168445cbf` | 0.458045 | 1.195546 | 0.737501 | 4863411.0 | 1286864 | 5868797 | 7472 | `405d97a83fbdceaed4f7845cc5c53f65688866aa18eb001cf20961c89a814016` | [x] |
| 20 | `9e30fff3d6effc7c71af92e8488f9375a5d70cf1962ba371bee0e639836dde38` | 0.672393 | 1.172248 | 0.499855 | 4768634.5 | 1286864 | 5868797 | 7472 | `405d97a83fbdceaed4f7845cc5c53f65688866aa18eb001cf20961c89a814016` | [x] |
...
|---:|---|---:|---:|---:|---|---|
| 8 | `ef85aaa88cf77914308133e388851874d2c21f50dca8f6b4053431a972481d18` | 0 | 3.289109 | 1.179135 | [x] | `74765238b1ab0358ae02000ccb5b1b8738a27a96e7f07eee10797dd58ec5423f` |
| 12 | `383a3107f63cba48b21ab684798524eca2b8e2c44c6a1894695277938e7e38ad` | 0 | 3.289358 | 1.180824 | [x] | `ecb4e8bbe8e37cdaa35acad468c8dd95d28e4bd266df6e55e777f11924f7cebd` |
| 16 | `f3e23ee218839f4ce2b6cc9a018da6e39fa4606edb2bde1eff57ba5690ea3421` | 0 | 3.289354 | 1.195546 | [x] | `86091351a47a2fdbd35e89e2cdbdb49bc7283645bce39a17614770523d77e7ab` |
| 20 | `62c3ea5e50082d3bc4ccacbe34ed429e67b3f2170c352354472622cfae59ec7b` | 0 | 3.289106 | 1.172248 | [x] | `906f6dc465303ea39f37d1689ab05915c986f77a90b90d68e8e3f831e1219195` |
...
| Script/environment hash | evaluator `405d97a83fbdceaed4f7845cc5c53f65688866aa18eb001cf20961c89a814016`; unigram JSON `6b44df438100bfa1880456f9e376cd6dc6810d70a2ad746c7f42cb4315208fcb` |
...
Written at `manifests/selection_record.json`. File SHA-256 `482917f327f2fa53bf8f8af30a1dc12ec13915a4d37086fcc1c57ec48f988cfe`. Inner `record_sha256` hashes the body without that field. See honesty note 1.

### E4. Selection sign-off

| Sign-off assertion | Yes / No | Evidence / initials / UTC |
|---|---|---|
| Selection used final full validation only. | Yes | `9d461cc5ad606d129e1de0be12ad372e63f5ee8bc4886b2969506625b057467f` / PP / 2026-08-16T07:56:24Z |
...
| `selection_record.json` is hashed and archived. | Yes | `482917f327f2fa53bf8f8af30a1dc12ec13915a4d37086fcc1c57ec48f988cfe` |
...
- [x] `selection_record.json` exists, is hashed, and identifies one selected final checkpoint. Sealed summary then named file `482917f327f2fa53bf8f8af30a1dc12ec13915a4d37086fcc1c57ec48f988cfe`; `D*=20`; ckpt `9e30fff3d6effc7c71af92e8488f9375a5d70cf1962ba371bee0e639836dde38`.
...
| Selected checkpoint SHA-256 | `9e30fff3d6effc7c71af92e8488f9375a5d70cf1962ba371bee0e639836dde38` |
| Selection record SHA-256 | `482917f327f2fa53bf8f8af30a1dc12ec13915a4d37086fcc1c57ec48f988cfe` (named file); sealed summary `9d461cc5ad606d129e1de0be12ad372e63f5ee8bc4886b2969506625b057467f` |
...
| Evaluator command hash | `405d97a83fbdceaed4f7845cc5c53f65688866aa18eb001cf20961c89a814016` |
| Host/environment fingerprint hash | `5cbe846f6181e6d105a19d8ac2ba49c4ed5d9f2fd0f832db457816060f8fe4c4` |
| Reason | Registered secondary `test_bpb` only; not model selection. |

Also in `manifests/test_access_log.json` SHA `b60511f97e6d4d6b1e0237fc645dcac319c87ada5e8acd7061890be55bbebe92`.
...
- [x] Test result is written once to a unique immutable result path. `p1-fixed-d20-3x_test_bpb.json` SHA `eeb953adb067cb471f9fe436841e745d9ba3c0f01151db06b1fbd6a2aca39074`.
...
|---|---|---|---|---|---|---|
| Finite final BPB | [x] | [x] | [x] | [x] | `9d461cc5ad606d129e1de0be12ad372e63f5ee8bc4886b2969506625b057467f` | pass |
| WikiText-TL-39 only in train directory | [x] | [x] | [x] | [x] | preflight `5cbe846f6181e6d105a19d8ac2ba49c4ed5d9f2fd0f832db457816060f8fe4c4` | pass |
| No test file/path in train directory | [x] | [x] | [x] | [x] | preflight + test log | pass |
| Val/test absent from tokenizer training | [x] | [x] | [x] | [x] | tokenizer manifest `5cd96dbe9936276e9ae60af490b54298d71ebbdb856cd0ef728cf2bca2637c1b` | pass |
...
| `D_actual` matches manifest | [x] | [x] | [x] | [x] | budget `0c67582d377e6bdb39bd009d8f38beb076db36601506825cefae7391fbf28c81` | pass |
| Final checkpoint/hash intact | [x] | [x] | [x] | [x] | `e25663f9fbade93889a8f05f75e710f5c275e9ce26d080800adee921d431751c` | pass |

### G2. Required deviation/incident inventory

| Event | Category | Does it alter primary claim? | Disclosure required? | Artifact |
|---|---|---|---|---|
| Original 2019 split unavailable; reconstructed article split used | Predeclared/clarified fallback | No; deterministic audit passed | Yes | `split_manifest.json` `b8c180a21addd9ac2bbb5b1bdb6ef7ae3246f5c58df925f7cb8a3abbb8b56326` |
| Final fixed-budget checkpoint interpretation | Pre-start operational clarification | No | Yes | clarifications `71c2b992ef1771fc7f31cad6d2f259d23d5c3b99367e7b9cbdcf7ae749552c8e` |
...
| Pod stopped after archive (`EXITED`) | Billing / ops | No | Yes | dashboard; GPU billing off |
...
CSV SHA `a4c00eda6faedb6bbb54fed6150cae253a7f5c032022109718b90db52a072fe9`. Components SHA `3ffb5da41bc0a73780690a4294b9b3d03a2a1b675d42b35b748b3d255e34ef36`.
...
| Selected final checkpoint SHA-256 | `9e30fff3d6effc7c71af92e8488f9375a5d70cf1962ba371bee0e639836dde38` |
...
- [x] Generate a recursive SHA-256 manifest after all output paths are final. `08_integrity/MANIFEST.sha256` SHA `06c4a990815ad168fd38af4a51ec2f2feece19abdf85b1f344ca9e0bb5a2e0aa`.
...
- [x] Export the full bundle off the ephemeral Pod before stopping it. Mac archive complete. Pod then **stopped (`EXITED`)**.
...
> **Selection-record SHA-256:** `482917f327f2fa53bf8f8af30a1dc12ec13915a4d37086fcc1c57ec48f988cfe`  
> **Test-result artifact SHA-256:** `eeb953adb067cb471f9fe436841e745d9ba3c0f01151db06b1fbd6a2aca39074`  
> **Archive manifest SHA-256:** `06c4a990815ad168fd38af4a51ec2f2feece19abdf85b1f344ca9e0bb5a2e0aa`
