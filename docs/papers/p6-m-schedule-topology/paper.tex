...
\noindent\textbf{Registration and deposits (P6-M):} AsPredicted \#307969 (\url{https://aspredicted.org/bk6m9d.pdf}); ResearchBox \#8918 (\url{https://researchbox.org/8918}; FOR PEER REVIEW, not Make Public); AsCollected \#2541 Version~1 (\url{https://ascollected.org/XZ8_TI5}; project \texttt{NANOCHAT-FILIPINO P6-M}; linked from box \#8918); study record \url{https://github.com/pageman/nanochat-filipino/tree/main/docs/p6}; GitHub trees \texttt{scripts/p6/}, \texttt{docs/run-cards/p6/}, \texttt{manifests/p6/}, \texttt{results/p6/}, \texttt{docs/hub/p6-m-schedule-topology/} under \url{https://github.com/pageman/nanochat-filipino}; Hub \url{https://huggingface.co/pageman/nanochat-filipino-p6-m-schedule-topology} (uploaded commit \texttt{5d3872b0}; topology children technical recreate). Run ID: \texttt{p6-20260824T155226Z-769f807a}. Manuscript version: v1.0.
...
\end{itemize}
Authority order: filed PDF $\gg$ SHA-bound addendum $\gg$ unmodified gate plan $\gg$ \texttt{LOCK.json}, manifests, and deterministic receipts $\gg$ this manuscript (v1.0). The study does not amend \#306780, \#306935, \#307342, \#307591, or \#307836. ResearchBox \#8918 remains FOR PEER REVIEW and is not made public by this paper. AsCollected \#2541 Version~1 (\url{https://ascollected.org/XZ8_TI5}) records public-corpus provenance and is linked from the box. Hub weights were uploaded after Gate~W with independent remote re-hash; topology children on Hub are a technical recreate (new SHAs).
...
\item AsCollected \#2541 Version~1: \url{https://ascollected.org/XZ8_TI5} (project \texttt{NANOCHAT-FILIPINO P6-M}; linked from box \#8918).
\end{itemize}
