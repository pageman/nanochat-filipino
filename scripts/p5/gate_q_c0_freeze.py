#!/usr/bin/env python3
"""P5 Gate Q_s: freeze TL0 d20 as immutable C0_s. No extra train tokens."""
...
def main() -> int:
    ...
    payload = {
        ...
        "allowed_child_tags": [child_tag(seed, a) for a in ("c1", "c2", "c3")],
    ...
    update_lock_gate(f"Q_{seed}", "pass", {"status": f"gate_q_{seed}_pass"})
