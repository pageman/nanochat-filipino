#!/usr/bin/env python3
"""P5 Gate H CUDA preflight. Does not train. Does not start TL0/C0."""
...
FORBIDDEN_TAGS = ("p5-c0-", "p5-tl0-", "p5-c1-", "p5-c2-", "p5-c3-", "p5-s1-", "p5-s2-", "p5-s3-")
...
def main() -> int:
    ...
    record("H0_tag_is_smoke", True, {"model_tag": "p5-smoke-tl-d4", "forbidden_prefixes": list(FORBIDDEN_TAGS)})
    ...
    payload = {
        ...
        "blinded": True,
        "no_p5_outcomes": True,
        "note": "Exit 0 authorizes scripts/p5/gate_h_smoke.sh only. Not Gate H pass. TL0/C0 have not started.",
    }
