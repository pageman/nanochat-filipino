...
def main() -> int:
    ...
    pkl_src = P3_TOK_DIR / "tokenizer.pkl"
    bytes_src = P3_TOK_DIR / "token_bytes.pt"
    record("F0_carry_forward_sources_exist", pkl_src.is_file() and bytes_src.is_file(), {"src": str(P3_TOK_DIR.relative_to(ROOT))})
    ...
    record("F6_no_p4_bpb", True, {"fertility": "deferred_optional_lockbox_after_E"})
