#!/usr/bin/env python3
"""Write Gate R authorization (C1 from frozen C0; filed parent seed)."""
...
def main() -> int:
    ...
    out = seed_card(args.seed) / "gate-r-authorization.json"
    payload = {
        ...
        "scope": (
            f"train C1 (extra Tagalog) from frozen C0 for seed {args.seed}; "
        ...
        "authorized_by": "operator chat: Do Gate R (C1 from C0)",
        "note": "Does not authorize S/T, validation seal, test, unblinding, or pod stop.",
    }
