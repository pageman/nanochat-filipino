#!/usr/bin/env python3
"""P6 Gate H CUDA preflight. Does not train. Does not start TL0/C0."""
...
FORBIDDEN_TAGS = ("p6-c0-", "p6-tl0-", "p6-c1-", "p6-c2-", "p6-c3-", "p6-s1-", "p6-s2-", "p6-s3-")
...
def main() -> int:
    ...
    record("H0_tag_is_smoke", True, {"model_tag": "p6-smoke-tl-d4", "forbidden_prefixes": list(FORBIDDEN_TAGS)})
    ...
    payload = {
        ...
        "blinded": True,
        "no_p5_outcomes": True,
        "note": "Exit 0 authorizes scripts/p6/gate_h_smoke.sh only. Not Gate H pass. TL0/C0 have not started.",
    }
