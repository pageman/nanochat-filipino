#!/usr/bin/env python3
"""Dummy P0-T: lockbox holds scalars; stdout/safe is PASS/BLOCKED/TECHNICAL BLOCK only."""
...
def main() -> int:
    ...
    p.add_argument("--status", choices=["PASS", "BLOCKED", "TECHNICAL BLOCK"], default="PASS")
    args = p.parse_args()
