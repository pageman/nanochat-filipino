#!/usr/bin/env python3
"""P3 Gate H CUDA preflight. Does not train. Does not start TL0."""
...
def main() -> int:
    ...
    checks = [
        ...
        {"id": "H0_last_shard_val", "ok": names[-1] == "shard_00002.parquet" if names else False, "detail": names},
        {"id": "H0_no_test_in_tl_dir", "ok": test_hits == []},
        {"id": "H0_cuda", "ok": cuda, "detail": {"gpu": gpu_name, "sm": sm}},
        {"id": "H0_nvidia_smi", "ok": nmi_ok, "detail": nmi_head or None},
        {"id": "H0_warmup_legal", "ok": True, "detail": "3 < 30"},
        {"id": "H0_tl0_not_started", "ok": True},
    ]
    ...
    payload = {
        ...
        "hashes": hashes,
        "checks": checks,
        "note": "Exit 0 authorizes scripts/p3/gate_h_smoke.sh only. Not Gate H pass. TL0 has not started.",
    }
