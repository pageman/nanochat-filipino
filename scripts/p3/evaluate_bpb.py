...
def main() -> int:
    ...
    os.environ.setdefault("NANOCHAT_BASE_DIR", str(P3_ROOT / "data" / "cache" / P3_RUN_ID))
    ...
    test_path = P3_ROOT / "data" / "processed" / "wikitext-tl39" / "test" / "test.jsonl"
    if test_path.exists():
    ...
    for depth, tag in TL0_DEPTHS.items():
        ...
        row = {
            "depth": depth,
            "model_tag": tag,
            "checkpoint_path": str(ckpt_path.relative_to(P3_ROOT)),
